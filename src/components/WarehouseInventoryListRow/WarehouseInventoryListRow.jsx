  ...
  return (
    ...
    <div className='warehouseInventory list-padding-side'>
        ...
        <div className="warehouseInventory__cell warehouseInventory__cell">
            ...
            <div className="warehouseInventory__cell_desc"><button className={`txt-table txt-bold warehouseInventory__cell_desc--btn ${inventory.status.toLowerCase() === 'in stock' ? 'instock':'outstock'}`}>{inventory.status}</button></div>
        </div>
        <div className="warehouseInventory__cell warehouseInventory__cell">
            <div className="warehouseInventory__cell_header txt-slate txt-table txt-bold">CATEGORY</div>
            <div className="warehouseInventory__cell_desc warehouseInventory__cell_desc--generic txt-m txt-black txt-regular">{inventory.category}</div>
        </div>
        <div className="warehouseInventory__cell">
            <div className="warehouseInventory__cell_header txt-slate txt-table txt-bold">QTY</div>
            <div className="warehouseInventory__cell_desc warehouseInventory__cell_desc--generic  txt-m txt-black txt-regular">{inventory.quantity}</div>
        </div>
        <div className="warehouseInventory__cell warehouseInventory__cell--full-width warehouseInventory__cell--flex-space-between">
            <img className='warehouseInventory__cell_btn'src={deleteIcon} alt="delete button" />
            <img className='warehouseInventory__cell_btn' src={editIcon} alt="edit button" />
        </div>
